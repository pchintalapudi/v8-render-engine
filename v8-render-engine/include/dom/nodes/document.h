	...
	namespace dom {
		namespace nodes {
			...
			public:
				...
				CO_READONLY_ATTRIBUTE(url);
				CO_READONLY_ATTRIBUTE(documentURI);
				CO_READONLY_ATTRIBUTE(compatMode);
				CO_READONLY_ATTRIBUTE(characterSet) {
				...
				CO_READONLY_ATTRIBUTE(doctype);
				CO_READONLY_ATTRIBUTE(documentElement);
				...
				CO_METHOD(importNode, pins::Pin<NodeContextObject>, pins::Pin<NodeContextObject> node, bool deep);
				CO_METHOD(adoptNode, pins::Pin<NodeContextObject>, pins::Pin<NodeContextObject> node);
