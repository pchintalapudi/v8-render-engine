...
#define MIXIN_PARENT_NODE	CO_READONLY_ATTRIBUTE(children, HTMLCollectionContextObject&);\
							...
							CO_METHOD(querySelectorAll, NodeListContextObject&, v8::Local<v8::String> selector);
...
#define MIXIN_SLOTABLE	CO_READONLY_ATTRIBUTE(assignedSlot, HTMLSlotElement*);
